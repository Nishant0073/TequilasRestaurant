...
namespace TequilasRestaurant.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductIngredient>().HasOne(p => p.Product).WithMany(p => p.ProductIngredients).HasForeignKey(p => p.ProductId);
            modelBuilder.Entity<ProductIngredient>().HasOne(p => p.Ingredient).WithMany(p => p.ProductIngredients).HasForeignKey(p => p.IngredientId);
